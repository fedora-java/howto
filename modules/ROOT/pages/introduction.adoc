...
the first time start reading <<XFor_Devs, Java developer>>
section. On the other hand if you are coming from RPM packaging background an
<<XFor_Packagers, introduction to Java world>> is probably a better starting
point.
